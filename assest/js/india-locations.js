...
const indiaLocations = {
    "Andhra Pradesh": [
        ...
        "Prakasam", "Srikakulam", "Sri Potti Sriramulu Nellore", "Visakhapatnam", "Vizianagaram", 
        "West Godavari", "YSR Kadapa"
    ],
    "Arunachal Pradesh": [
        "All Districts", "Tawang", "West Kameng", "East Kameng", "Papum Pare", "Kurung Kumey", 
        "Kra Daadi", "Lower Subansiri", "Upper Subansiri", "West Siang", "East Siang", "Siang", 
        "Upper Siang", "Lower Siang", "Lower Dibang Valley", "Dibang Valley", "Anjaw", "Lohit", 
        "Namsai", "Changlang", "Tirap", "Longding"
    ],
    "Assam": [
        "All Districts", "Baksa", "Barpeta", "Biswanath", "Bongaigaon", "Cachar", "Charaideo", 
    ...
    "Bihar": [
        "All Districts", "Araria", "Arwal", "Aurangabad", "Banka", "Begusarai", "Bhagalpur", 
    ...
    "Chhattisgarh": [
        "All Districts", "Balod", "Baloda Bazar", "Balrampur", "Bastar", "Bemetara", "Bijapur", 
        "Bilaspur", "Dantewada", "Dhamtari", "Durg", "Gariaband", "Janjgir-Champa", "Jashpur", 
        "Kabirdham", "Kanker", "Kondagaon", "Korba", "Koriya", "Mahasamund", "Mungeli", 
        "Narayanpur", "Raigarh", "Raipur", "Rajnandgaon", "Sukma", "Surajpur", "Surguja"
    ],
    "Goa": [
        "All Districts", "North Goa", "South Goa"
    ],
    "Gujarat": [
        "All Districts", "Ahmedabad", "Amreli", "Anand", "Aravalli", "Banaskantha", "Bharuch", 
    ...
    "Haryana": [
        "All Districts", "Ambala", "Bhiwani", "Charkhi Dadri", "Faridabad", "Fatehabad", 
    ...
    "Himachal Pradesh": [
        "All Districts", "Bilaspur", "Chamba", "Hamirpur", "Kangra", "Kinnaur", "Kullu", 
        "Lahaul and Spiti", "Mandi", "Shimla", "Sirmaur", "Solan", "Una"
    ],
    "Jharkhand": [
        "All Districts", "Bokaro", "Chatra", "Deoghar", "Dhanbad", "Dumka", "East Singhbhum", 
    ...
    "Kerala": [
        "All Districts", "Alappuzha", "Ernakulam", "Idukki", "Kannur", "Kasaragod", "Kollam", 
        "Kottayam", "Kozhikode", "Malappuram", "Palakkad", "Pathanamthitta", "Thiruvananthapuram", 
        "Thrissur", "Wayanad"
    ],
    "Madhya Pradesh": [
        "All Districts", "Agar Malwa", "Alirajpur", "Anuppur", "Ashoknagar", "Balaghat", "Barwani", 
    ...
    "Maharashtra": [
        "All Districts", "Ahmednagar", "Akola", "Amravati", "Aurangabad", "Beed", "Bhandara", 
    ...
    "Manipur": [
        "All Districts", "Bishnupur", "Chandel", "Churachandpur", "Imphal East", "Imphal West", 
        "Jiribam", "Kakching", "Kamjong", "Kangpokpi", "Noney", "Pherzawl", "Senapati", 
        "Tamenglong", "Tengnoupal", "Thoubal", "Ukhrul"
    ],
    "Meghalaya": [
        "All Districts", "East Garo Hills", "East Jaintia Hills", "East Khasi Hills", 
        "North Garo Hills", "Ri Bhoi", "South Garo Hills", "South West Garo Hills", 
        "South West Khasi Hills", "West Garo Hills", "West Jaintia Hills", "West Khasi Hills"
    ],
    "Mizoram": [
        "All Districts", "Aizawl", "Champhai", "Kolasib", "Lawngtlai", "Lunglei", "Mamit", 
        "Saiha", "Serchhip"
    ],
    "Nagaland": [
        "All Districts", "Dimapur", "Kiphire", "Kohima", "Longleng", "Mokokchung", "Mon", 
        "Peren", "Phek", "Tuensang", "Wokha", "Zunheboto"
    ],
    "Odisha": [
        "All Districts", "Angul", "Balangir", "Balasore", "Bargarh", "Bhadrak", "Boudh", 
    ...
    "Rajasthan": [
        "All Districts", "Ajmer", "Alwar", "Banswara", "Baran", "Barmer", "Bharatpur", "Bhilwara", 
    ...
    "Sikkim": [
        "All Districts", "East Sikkim", "North Sikkim", "South Sikkim", "West Sikkim"
    ],
    "Tamil Nadu": [
    ...
    "Tripura": [
        "All Districts", "Dhalai", "Gomati", "Khowai", "North Tripura", "Sepahijala", 
        "South Tripura", "Unakoti", "West Tripura"
    ],
    "Uttar Pradesh": [
        "All Districts", "Agra", "Aligarh", "Ambedkar Nagar", "Amethi", "Amroha", "Auraiya", 
    ...
    "Uttarakhand": [
        "All Districts", "Almora", "Bageshwar", "Chamoli", "Champawat", "Dehradun", "Haridwar", 
        "Nainital", "Pauri Garhwal", "Pithoragarh", "Rudraprayag", "Tehri Garhwal", 
        "Udham Singh Nagar", "Uttarkashi"
    ],
    "West Bengal": [
        "All Districts", "Alipurduar", "Bankura", "Birbhum", "Cooch Behar", "Dakshin Dinajpur", 
