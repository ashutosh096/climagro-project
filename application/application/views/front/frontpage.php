    ...
    foreach ($sliderlist as $slider) { ?>
        ...
        <div class="container pos-rel">
            <div class="hero__content-wrap hero-style-two text-center">
                <h2 class="title" style="color: #fff;;">We <span id="typed-text2" style="color: var(--color-primary);"></span></h2>
            ...
            <div class="col-lg-6">
                <div class="climate-content wow fadeInUp" data-wow-duration=".7s" data-wow-delay="450ms" >
                    <h4 style = "color : #025b5f">At ClimAgro,</h4>
                    <h3 style = "color : #025b5f ; font-weight : bold">Discover Future of Climate Risk Management</h3>
                    <h5 class ="tile-content" style = "color : #025b5f ; margin-top :2rem">Unlock the power of advanced climate risk intelligence with a personalized demo! See firsthand how our cutting- edge solutions can help you navigate climate uncertainties.</h5>
          ...
          <div class="product-content">
            <div class="content-wrapper">
              ...
              <div class="fade-in">
                ...
                <a href="<?= base_url('solutions'); ?>" class="learn-btn  p-0  d-inline-flex align-items-center">
                  Learn more
        ...
        <div class="product-card">
          ...
          <div class="product-content">
            <div class="content-wrapper">
              ...
              <div class="fade-in">
                <a href="<?php echo base_url('climatedata') ?>" class="login-btn" style="display: inline-flex; align-items: center; gap: 0.5rem;">
                  Try for free
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round">
                    <line x1="5" y1="12" x2="19" y2="12"></line>
...
<section class="partners-section">
    <div class="container">
        ...
        <h2 class="section-title">Partners & Incubators</h2>
        ...
        <div class="partners-container">
            ...
            <div class="partners-scroll-container">
                <div class="partners-wrapper" id="partnersWrapper">
                    <?php
