...
<style>
    ...
    @media (max-width: 991px) {
        ...
        .login-btn { font-size: 13px !important; padding: 8px 14px !important; white-space: nowrap !important; }
                    ...
                    <div class="header-btn ul_li">
                        <a class="login-btn" style="text-decoration: none !important;" href="<?php echo base_url('contact-us').'#formcontact' ?>">Contact Us</a>
                        <div class="header-bar-mobile side-menu d-lg-none">
                            <a class="xb-nav-mobile" href="javascript:void(0);" onclick="document.body.classList.add('xb-sidebar-open');"><i class="fas fa-bars"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    (function() {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (closeBtn) closeBtn.onclick = function(e){ e.preventDefault(); closeNav(); };
            var backdrop = document.querySelector('.xb-header-menu-backdrop');
            if (backdrop) backdrop.onclick = function(e){ e.preventDefault(); closeNav(); };
        });
    })();
    </script>
